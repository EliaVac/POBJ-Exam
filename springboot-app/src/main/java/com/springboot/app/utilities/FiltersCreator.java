...
public class FiltersCreator {
	...
	public FiltersCreator() {
		...
		possiblefilter.filtersStatcollection.put("increment", "Identify the 'minimum' and/or 'maximum' of records increment with an object");
		possiblefilter.filtersStatcollection.put("decrement", "Identify the 'minimum' and/or 'maximum' of records decrement with an object");
		possiblefilter.filtersStatcollection.put("total", "Identify the 'minimum' and/or 'maximum' of total records with an object");
	}
