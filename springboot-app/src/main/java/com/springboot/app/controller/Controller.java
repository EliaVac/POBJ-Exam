...
public class Controller {
	...
	/**
	 * The root associated with "/getdatabase" that permits to get filtered database
	 * by the JSON parameter "filter" inserted
	 * 
	 * @param filter
	 * @return the database
	 * @throws JSONProblem
	...
	public ResponseEntity<Object> getdatabase(@RequestBody String filter)
	...
	/**
	 * The root associated with "/getstats" that permits to get the filtered
	 * statistics by the JSON parameter "filter" inserted
	 * 
	 * @param filter
	 * @return the statistics
	 * @throws JSONProblem
